...
def print_arbitrage_opportunities(option_data):
    for i, option in enumerate(option_data):
        ...
        if option_type.casefold() == "put".casefold():
            if option_info.casefold() == "alım".casefold() and option_price > strike_price - spot_price:
                print(f"Arbitrage opportunity detected in Put option {i+1}")
            ...
            if option_info.casefold() == "alım".casefold() and option_price > spot_price - strike_price:
                print(f"Arbitrage opportunity detected in Call option {i+1}")
...
def main():
    ...
    print_arbitrage_opportunities(option_data)
