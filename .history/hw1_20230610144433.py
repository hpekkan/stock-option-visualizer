        ...
        for option in option_data:
            if option["option_type"].casefold() == "put".casefold():
                if option["option_info"].casefold() == "alım".casefold():
                    ...
                    option_profit = option_profit + long_put(option["strike_price"],option_x[i],option["option_price"])*stock_quantity
                else:
                    profit = profit + short_put(option["strike_price"],option_x[i],option["option_price"])*stock_quantity
                    option_profit = option_profit + short_put(option["strike_price"],option_x[i],option["option_price"])*stock_quantity
            else:
                if option["option_info"].casefold() == "alım".casefold():
