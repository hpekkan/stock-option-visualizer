...
def main():
    ...
    for k in range(option_quantity):
        plt.plot(option_x, option_profits[k], label=f'Opsiyon {k+1} Kar/Zarar', linestyle='dashed' ,dashes=(3, 3))  # Plot each option profit separately
    if stock_quantity > 0:
        plt.plot(option_x, stock_profit_x, color='blue', label='Hisse Senedi Kar/Zarar',linestyle='dashed',dashes=(3, 3))
