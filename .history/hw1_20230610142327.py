...
def main():
    ...
    for i in range(1, 100):
        if option_y[i] != option_y[i-1]:
            if option_y[i] > option_y[i-1]:
                print("Option arbitrage opportunity: Buy at spot price", option_x[i-1], "and sell at spot price", option_x[i])
            else:
                print("Option arbitrage opportunity: Sell at spot price", option_x[i-1], "and buy at spot price", option_x[i])
    ...
    if max_profit != min_profit:
        ...
        if max_profit > min_profit:
            print("Stock arbitrage opportunity: Buy at spot price", option_x[min_index], "and sell at spot price", option_x[max_index])
        else:
            print("Stock arbitrage opportunity: Sell at spot price", option_x[min_index], "and buy at spot price", option_x[max_index])
