...
def main():
    ...
    # Display intersection coordinates as text
    for intersection in intersections:
        plt.text(option_x[intersection], -22, f'({option_x[intersection]:.2f}, 0)', ha='center', va='bottom')
    ...
    # Display intersection coordinates as text
    for intersection in intersections:
        plt.text(option_x[intersection], -20, f'({option_x[intersection]:.2f}, 0)', ha='center', va='bottom')
