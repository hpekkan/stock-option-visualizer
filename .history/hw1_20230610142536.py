...
def main():
    ...
    if max_profit != min_profit:
        ...
        if max_profit > min_profit:
            print("Stock arbitrage opportunity: Buy at option price",i-1, option_x[min_index], "and sell at spot price", option_x[max_index])
        else:
            print("Stock arbitrage opportunity: Sell at option price",i-1, option_x[min_index], "and buy at spot price", option_x[max_index])
