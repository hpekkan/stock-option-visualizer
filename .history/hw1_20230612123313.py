...
def main():
    ...
    # Plot intersection points on the x-axis
    for intersection in intersections:
        plt.plot(option_x[intersection], 0, 'ro')  # Plot red dots at the intersection points
        anchored_text = AnchoredText(f'({option_x[intersection]:.2f}, 0)', loc='center left')
