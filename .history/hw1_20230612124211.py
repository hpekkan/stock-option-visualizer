...
def main():
    ...
    for intersection in intersections:
        plt.text(option_x[intersection], -5, f'({option_x[intersection]:.2f}, 0)', ha='center', va='bottom')
    ...
    # Display intersection coordinates as text
    for intersection in intersections:
        plt.text(option_x[intersection], -10, f'({option_x[intersection]:.2f}, 0)', ha='center', va='bottom')
