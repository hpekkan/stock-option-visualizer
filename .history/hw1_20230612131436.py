...
def main():
   ...
   # Find intersection points
    ...
    # Find intersection points
    intersections = np.argwhere(np.diff(np.sign(np.sum(option_profits, axis=0)))).flatten()
    ...
    plt.legend(loc='upper left', bbox_to_anchor=(0.5, 1.15), bbox_transform=plt.gcf().transFigure, prop={'size': 12})
